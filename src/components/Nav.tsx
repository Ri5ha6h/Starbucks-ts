...
const Nav: React.FC<Props> = (props) => {
  ...
  return (
    <>
      <nav
        className={
          'relative shadow-md flex items-center z-40 justify-between h-24 px-2 mx-auto bg-white md:sticky md:top-0 md:z-10 sm:px-6 lg:px-8 xl:px-12 '
        }
      >
        ...
        <div className="items-center justify-between hidden w-full space-x-4 md:flex">
          <ul className="flex items-center justify-center h-24 text-lg font-medium uppercase ">
            <li className=" md:ml-3 lg:ml-5 hover:text-primary-200">
              <NavLink to="/" className="h-full">
                Menu
              </NavLink>
            </li>
            <li className="md:ml-3 lg:ml-5 hover:text-primary-200 ">
              <NavLink to="/reward" className="h-full cursor-pointer">
                Rewards
              </NavLink>
            </li>
            <li className=" md:ml-3 lg:ml-5 hover:text-primary-200">
              <NavLink to="/gift" className="h-full">
                Gift Cards
              </NavLink>
            </li>
          </ul>
          <ul className="flex flex-row-reverse items-center h-24">
            <li className="md:ml-3 lg:ml-5">
              <ButtonLinks className=" hover:bg-gray-200">Sign in</ButtonLinks>
            </li>
            <li className="md:ml-3 lg:ml-5">
              <ButtonLinks className="text-white bg-black hover:bg-gray-700">
                Join now
              </ButtonLinks>
            </li>
            <li className="text-base font-medium">
              <a href="./" className="relative h-full hover:text-primary-200">
                <svg
                  viewBox="0 0 24 24"
                  className="absolute w-6 h-6 overflow-visible fill-current -ml-9"
        ...
        <div className="md:hidden">
          ...
          <button
            ...
            className={'focus:outline-none ' + (isOpen ? 'block' : 'hidden')}
          >
            <svg
              className="block w-6 h-6 fill-current"
              xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="divide-y-2 divide-gray-200 ">
                ...
                <div className="py-10">
                  <ul className="sm:flex">
                    <li>
                      <ButtonLinks className=" hover:bg-gray-200">
                        Sign in
                      </ButtonLinks>
                    </li>
                    <li className="mt-4 sm:mt-0 sm:pl-5">
                      <ButtonLinks className="text-white bg-black hover:bg-gray-700">
                        Join now
                      </ButtonLinks>
                    </li>
                  ...
                  <ul className="mt-5">
                    <li className="text-lg">
                      <a href="/" className="h-full hover:text-primary-200">
                        <svg
                          viewBox="0 0 24 24"
                          className="inline-block w-6 h-6 overflow-visible fill-current"
                          preserveAspectRatio="xMidYMid meet"
                          aria-hidden="true"
                          focusable="false"
                        >
